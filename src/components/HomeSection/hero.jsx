          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-4 md:space-y-6 pt-8 md:pt-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-6">
                ...
                <button className="border-2 border-orange-400 text-orange-400 px-6 md:px-8 py-2 md:py-3 rounded-lg hover:bg-orange-500/10 transition-colors duration-200 font-semibold text-sm md:text-base">
                  Learn More
                </button>
              </div>
            </div>
